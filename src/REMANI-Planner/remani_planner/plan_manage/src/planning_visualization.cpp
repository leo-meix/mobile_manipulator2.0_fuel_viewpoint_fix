...
namespace remani_planner
{
  ...
  void PlanningVisualization::displayGlobalTraj(vector<Eigen::Vector2d> init_pts, const double scale, int id)
  {
    ...
    // Publish the sampled global trajectory as a continuous line instead of
    // rendering every sample as a blue sphere.
    displayMarkerList(global_traj_pub, init_pts_3d, scale, color, id, false);
  }
