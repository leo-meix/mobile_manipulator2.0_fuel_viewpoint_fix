...
namespace remani_planner
{
    ...
    private:
        ...
        std::string mesh_resource_mobile_base_, mesh_resource_mobile_wheel_, mesh_resource_fastarmer_base0_, mesh_resource_fastarmer_link1_, mesh_resource_fastarmer_link2_;
